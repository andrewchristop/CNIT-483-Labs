...
model.add(layers.GRU(64, activation='relu' ,input_shape=(5,1))) #Importing GRU layer with 64 computing nodes, using relu activation function
...
history = model.fit(x_train, y_train, validation_data=(x_test, y_test), batch_size=32, epochs=100) #Running the model at 100 epochs
